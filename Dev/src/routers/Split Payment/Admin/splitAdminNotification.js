...
class splitAdminNotification extends Component {
  ...
  handleNotificationClick(notification) {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "OnePayDashboard/IsReadAdminNotification",
      headers: authHeader(),
      data: {
  ...
  handleGetNotifications() {
    ...
    axios({
      method: "get",
      url: config.apiUrl + "OnePayDashboard/adminnotificationdetails",
      headers: authHeader(),
    })
      .then(function (res) {
...
export default splitAdminNotification;
