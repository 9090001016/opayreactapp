...
class ForgotPassword extends Component {
  ...
  handleFinaleSubmit = (e) => {
    ...
    if (this.state.emailId) {
      ...
      axios({
        method: "post",
        url: config.apiUrl + "AccountAdmin/ForgetPassword",
        headers: {
  ...
  handleOTPSubmit() {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "AccountAdmin/AdminEmailOTPVerification",
      ...
      .then(function (res) {
        ...
        if (status === "Success") {
          ...
          window.location.href = `/instantPayAdminResetPassword`;
        } else {
