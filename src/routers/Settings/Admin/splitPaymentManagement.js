...
class splitPaymentManagement extends Component {
  ...
  handleEditSplitOpen(splitPaymentId) {
    ...
    axios({
      method: "get",
      url: config.apiUrl + "SplitPayment/GetSplitPaymentById",
      headers: authHeader(),
      params: {
  ...
  handleGetSplitPaymentList(search, pagination, sorter) {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "SplitPayment/getlistsplitpayment",
      headers: authHeader(),
      data: {
        SearchBy: search,
  ...
  handleGetSplitPaymentCSV() {
    
    let self = this;
    var splitPaymentCSVData = [];
    axios({
      method: "get",
      url: config.apiUrl + "SplitPayment/splitpaymentexportexcel",
      headers: authHeader()
    })
      .then(function (res) {
  ...
  handleSplitPaymentSubmit() {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "SplitPayment/InsertUpdateSplitPayment",
      headers: authHeader(),
      data: {
  ...
  handleSplitPaymentDelete(splitPaymentId) {
    ...
    axios({
      method: "delete",
      url: config.apiUrl + "SplitPayment/DeleteSplitPayment",
      headers: authHeader(),
      params: {
        splitPaymentId: splitPaymentId,
      },
