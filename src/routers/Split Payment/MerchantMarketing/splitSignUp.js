...
class splitSignUp extends Component {
    ...
    handleVerifyMobileFieldClick = () => {
        ...
        if (this.state.mobileNo) {
            ...
            axios({
                method: "post",
                url: config.apiUrl + "OnePayMerchantMarketing/MerchantMobileOTP",
    ...
    handleConfirmMobileOTP = () => {
        ...
        axios({
            method: "post",
            url: config.apiUrl + "OnePayMerchantMarketing/MerchantMobileOTPVerification",
            headers: authHeader("no"),
            data: {
                MobileNo: this.state.mobileNo,
    ...
    handleMerchantSignUP() {
        ...
        if (this.handleValidation()) {
            ...
            axios({
                method: "post",
                url: config.apiUrl + "OnePayMerchantMarketing/MerchantSignUp",
                headers: authHeader("no"),
                data: {
    ...
    handleBusinessTypeList() {
        ...
        axios({
            method: "get",
            url: config.apiUrl + "OnePayMerchantMarketing/MerchantBusinessType",
            headers: authHeader("no")
        })
            .then(function (res) {
                let status = res.data.message;
