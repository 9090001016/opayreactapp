...
import backgroundwave from "../../../../src/assets/Images/allicons/Rectangle.png";
    ...
    return (
        <div>
            <footer className='footer1'>
                <img src={backgroundwave} alt="" className='wave_img' />
                <div className='grid grid_five_columns footer_part'>
                    <div>
                        <NavLink to="#">
            ...
            {/* <div className='footer_para'>© Text, Inc. 2019. We love our users!</div> */}
        </div>
    )
}
