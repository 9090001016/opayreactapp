...
class splitMerchantStripeAccount extends Component {
    constructor(props) {
        super(props);
    ...
    handleUpdateMerchantAccount(merchantId) {
        ...
        axios({
            method: "post",
            url: config.apiUrl + "OnePayMerchantMarketing/updatemerchantaccount",
...
export default splitMerchantStripeAccount;
