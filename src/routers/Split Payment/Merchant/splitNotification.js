...
class splitNotification extends Component {
  constructor(props) {
    super(props);
  ...
  handleNotificationClick(notification) {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "OnePayMerchantDashboard/IsReadNotification",
  ...
  handleGetNotifications(pagination, sorter) {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "OnePayMerchantDashboard/NotificationDetails",
      headers: merchantAuthHeader(),
      data: {
