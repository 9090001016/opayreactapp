...
class SplitCheckoutForm extends React.Component {
    constructor(props) {
        super(props)
    ...
    handleSubmitSubscriptionDetails(cardDetails, cardElement) {
        ...
        axios({
            method: "post",
            url: config.apiUrl + "OnePayPlanSubscription/sendmerchantcarddetail",
            headers: merchantAuthHeader(),
            data: {
    ...
    handleFinalPayment(cardDetails, finalPaymentDetails) {
        ...
        axios({
            method: "post",
            url: config.apiUrl + "OnePayPlanSubscription/getfinalpaymentstatus",
            headers: merchantAuthHeader(),
            data: {
...
export default function InjectedCheckoutForm() {
    return (
        <ElementsConsumer>
            {({ stripe, elements }) => (
                <SplitCheckoutForm stripe={stripe} elements={elements} />
            )}
        </ElementsConsumer>
    );
}
