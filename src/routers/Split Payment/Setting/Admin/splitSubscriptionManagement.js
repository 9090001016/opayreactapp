...
class splitSubscriptionManagement extends Component {
  ...
  handleGetSubscriptionList(search, pagination, sorter) {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "OnePaySubscription/SubscriptionList",
      headers: authHeader(),
      data: {
        searchBy: search,
  ...
  handleSubscriptionSubmit() {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "OnePaySubscription/CreateSubscription",
      headers: authHeader(),
      data: {
  ...
  handleSubscriptionDelete(subscriptionId) {
    ...
    axios({
      method: "delete",
      url: config.apiUrl + "OnePaySubscription/DeleteSubscription",
      headers: authHeader(),
      params: {
  ...
  handleSubscriptionUpdate() {
    ...
    axios({
      method: "put",
      url: config.apiUrl + "OnePaySubscription/UpdateSubscription",
      headers: authHeader(),
      data: {
...
export default splitSubscriptionManagement;