...
class rolespermission extends Component {
  ...
  handleGetMappedModulesList() {
    ...
    axios({
      method: "get",
      url: config.apiUrl + "OnePayMerchantSetting/MerchantModuleList",
  ...
  handleDeleteRolesPermissions(roleID) {
    ...
    axios({
      method: "delete",
      url: config.apiUrl + "OnePayMerchantSetting/DeleteMerchantRolePermission",
      headers: merchantAuthHeader(),
      params: {
        roleID,
      },
  ...
  handleGetMappedSubModulesList() {
    ...
    if (this.state.roleInfo.modules.length > 0) {
      ...
      axios({
        method: "get",
        url: config.apiUrl + "OnePayMerchantSetting/MerchantSubModuleList",
        headers: merchantAuthHeader(),
        params: {
  ...
  handleGetRolesPermissionsList(search) {
    ...
    axios({
      method: "get",
      url: config.apiUrl + "OnePayMerchantSetting/MerchantRolePermissionsList",
      headers: merchantAuthHeader(),
      params: {
        searchBy: search,
      },
  ...
  handleEditRole() {
    ...
    axios({
      method: "put",
      url: config.apiUrl + "OnePayMerchantSetting/UpdateMerchantRoleAndPermission",
      headers: merchantAuthHeader(),
      data: {
  ...
  handleAddRole() {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "OnePayMerchantSetting/CreateMerchantRoleAndPermission",
      headers: merchantAuthHeader(),
      data: {
        RoleName: this.state.roleInfo.name,
        SubmoduleIDs: this.state.roleInfo.subModules.join("|"),
