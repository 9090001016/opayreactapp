...
class splitAdminMerchantManagementDetails extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    document.getElementById("splitMerchantMmt").classList.add("active");
...
export default splitAdminMerchantManagementDetails;
