...
class splitAdminMerchantManagement extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubscriptionTypePeriodList() {
    ...
    axios({
      method: "get",
      url: config.apiUrl + "OnePayTransaction/SubscriptionMaster",
      headers: authHeader(),
    })
      .then(function (res) {
  ...
  handleGetMerchantManagementList(pagination, sorter) {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "OnePayTransaction/TransactionManagementTransactionList",
      headers: authHeader(),
      data: {
  ...
  handleAdminApprove = (merchantId, merchantName, merchantEmailId, merchantContactNo) => {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "OnePayTransaction/isadminaprrove",
      headers: authHeader(),
      data: {
        MerchantId: merchantId,
  ...
  handleMerchantDeactivate(merchantId) {
    ...
    axios({
      method: "delete",
      url: config.apiUrl + "OnePayMerchantTransaction/deactivateMerchant",
      headers: authHeader(),
      params: {
        userid: merchantId,
      },
...
export default splitAdminMerchantManagement;
