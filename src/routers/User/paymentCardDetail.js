...
class PaymentCardDetail extends Component {
  constructor(props) {
    super(props)
  ...
  handleGetCardDetails() {
    ...
    axios({
      method: "get",
      url: config.apiUrl + "PaymentDetail/getcarddetails",
  ...
  handlUpdateDefaultCard() {
    ...
    axios({
      method: "put",
      url: config.apiUrl + "PaymentDetail/updatecarddetails",
      headers: userAuthHeader(),
      data: {
  ...
  handlDeleteCardDetails(customerCardId) {
    ...
    axios({
      method: "delete",
      url: config.apiUrl + "PaymentDetail/deletecarddetails",
      headers: userAuthHeader(),
      params: {
...
export default function InjectedCheckoutForm() {
  return (
    <ElementsConsumer>
      {({ stripe, elements }) => (
        <PaymentCardDetail stripe={stripe} elements={elements} />
      )}
    </ElementsConsumer>
  );
}
