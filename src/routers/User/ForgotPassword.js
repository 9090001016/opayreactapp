...
class ForgotPassword extends Component {
  ...
  handleFinaleSubmit = (e) => {
    ...
    if (this.state.emailId) {
      ...
      axios({
        method: "post",
        url: config.apiUrl + "UserAccount/ForgetPassword",
        headers: {
  ...
  handleOTPSubmit() {
    ...
    axios({
      method: "post",
      url: config.apiUrl + "UserAccount/customeremailotpverification",
      ...
      .then(function (res) {
        ...
        if (status === "Success") {
          ...
          window.location.href = `/instantPayUserResetPassword`;
        } else {
