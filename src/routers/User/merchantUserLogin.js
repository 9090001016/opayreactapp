...
class merchantUserLogin extends Component {
  constructor(props) {
    super(props);
  ...
  handleFinaleSubmit(e) {
    ...
    if (userName && password) {
      ...
      axios({
        method: "get",
        url: config.apiUrl + "UserAccount/userlogin",
        headers: {
        ...
        .then(function (res) {
          ...
          if (resValid === "Valid Login") {
            ...
            window.localStorage.setItem("instantusertoken", res.data.responseData.token);
            var url = window.localStorage.getItem("iframeUrl");
            setTimeout(function () {
            ...
            cookies.set("instantusertoken", res.data.responseData.token, { path: "/", maxAge: 86400 });
          } else {
          ...
          <div className="sign-in-card">
            ...
            <form name="sign-in-form" onSubmit={this.handleFinaleSubmit}>
              ...
              <div className="flex-parted">
                <span></span>
                <Link
                  to="instantPayUserForgotPassword"
...
export default merchantUserLogin;
