...
class userSignUp extends Component {
    ...
    handleVerifyMobileFieldClick = () => {
        ...
        if (this.state.mobileNo) { // if (this.state.mobileNo.length == 10) {
            ...
            axios({
                method: "post",
                url: config.apiUrl + "MerchantMarketing/UserMobileOTP",
                headers: userAuthHeader("no"),
                data: {
    ...
    handleConfirmMobileOTP = () => {
        ...
        axios({
            method: "post",
            url: config.apiUrl + "MerchantMarketing/UserMobileOTPVerification",
            headers: userAuthHeader("no"),
            data: {
                MobileNo: this.state.mobileNo,
    ...
    handleVerifyEmailFieldClick = () => { // this.setState({ isVerifyEmail: !this.state.isVerifyEmail });
        ...
        axios({
            method: "post",
            url: config.apiUrl + "MerchantMarketing/UserEmailOTP",
            headers: userAuthHeader("no"),
            data: {
    ...
    handleConfirmEmailOTP = () => {
        ...
        axios({
            method: "post",
            url: config.apiUrl + "MerchantMarketing/UserEmailOTPVerification",
            headers: userAuthHeader("no"),
            data: {
                EmailId: this.state.emailId,
    ...
    handleUserSignUP() {
        ...
        if (this.handleValidation()) {
            ...
            axios({
                method: "post",
                url: config.apiUrl + "MerchantMarketing/InsertUserSignUp",
                headers: userAuthHeader("no"),
                data: {
                ...
                <Link to="/">
                    ...
                    <div className="sign-in-card">
                        ...
                        <div className="resbtncss">
                            <button className="butn lefbtn"
                                onClick={
                                    this.handleUserSignUP.bind(this)
